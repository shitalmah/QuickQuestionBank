...
{
    public class DeleteQuestionAnswerMappingRequestHandler : IRequestHandler<DeleteQuestionAnswerMappingQuery, Response<int?>>
    {
        ...
        public async Task<Response<int?>> Handle(DeleteQuestionAnswerMappingQuery request, CancellationToken cancellationToken)
        {
